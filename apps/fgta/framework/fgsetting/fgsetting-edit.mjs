...
import * as hnd from  './fgsetting-edit-hnd.mjs'
...
const obj = {
	txt_setting_id: $('#pnl_edit-txt_setting_id'),
	txt_setting_value: $('#pnl_edit-txt_setting_value'),
	txt_setting_scope: $('#pnl_edit-txt_setting_scope'),
	txt_setting_tag: $('#pnl_edit-txt_setting_tag'),
	txt_setting_descr: $('#pnl_edit-txt_setting_descr')
}
