...
import * as hnd from  './fguser-edit-hnd.mjs'
...
const obj = {
	txt_user_id: $('#pnl_edit-txt_user_id'),
	txt_user_name: $('#pnl_edit-txt_user_name'),
	txt_user_fullname: $('#pnl_edit-txt_user_fullname'),
	txt_user_email: $('#pnl_edit-txt_user_email'),
	txt_user_password: $('#pnl_edit-txt_user_password'),
	cbo_group_id: $('#pnl_edit-cbo_group_id'),
	chk_user_disabled: $('#pnl_edit-chk_user_disabled')
}
...
export async function init(opt) {
	...
	obj.cbo_group_id.name = 'pnl_edit-cbo_group_id'		
...
export function open(data, rowid, viewmode=true, fn_callback) {
	...
	var fn_dataopened = async (result, options) => {
		...
		*/
		...
		form
			.fill(record)
			.setValue(obj.cbo_group_id, record.group_id, record.group_name)
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.user_disabled = '0'

		data.group_id = '0'
		data.group_name = '-- PILIH --'
		...
		$ui.getPages().ITEMS['pnl_editgroupsgrid'].handler.createnew(data, options)
