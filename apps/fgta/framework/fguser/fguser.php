...
if (is_file(__DIR__ .'/fguser.php-handler.php')) {
	require_once __DIR__ .'/fguser.php-handler.php';
}

/**
 * fgta/framework/fguser/fguser.php
 *
 * ===================================================================
 * Entry point Program Module fguser
 * ===================================================================
 ...
 * terakhir di generate tanggal 06/02/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\fguser_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new fguser_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
