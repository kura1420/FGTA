 ...
 * kelas ini harus di-inherit untuk semua api pada modul {__BASENAME__}
 *
 ...
 * tanggal {__GENDATE__}
 */
class {__BASENAME__}Base extends WebAPI {
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*{__BASENAME__}*/.txt";
		// debug::disable();
